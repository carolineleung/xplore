...
@implementation XploreAppDelegate
...
@synthesize facebook = _facebook, navigationController = _navigationController, rootController = _rootController;
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"xplore" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"xplore.sqlite"];
